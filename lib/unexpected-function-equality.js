...
function stringifyFunction(fn) {
    ...
    var functionAst = esprima.parse('!' + fn.toString()).body[0].expression.argument;
    if (fn._name) {
...
module.exports = {
    ...
    installInto: function (expect) {
        expect.addAssertion('<function> to equal <function>', function (expect, subject, value) {
            expect(stringifyFunction(subject), 'to equal', stringifyFunction(value));
        });
    }
};
